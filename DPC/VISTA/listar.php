...
<tr>
  ...
  <th>
  <a href="confirmarBorrar.php?id=<?php echo $valor['usua_codigo']?>&nombre=<?php echo $valor['usua_nombre']?>"><img src="img/eliminar.png"></a>
</th>
<th>
  <a href="actualizar_usu.php?id=<?php echo $valor['usua_codigo']?>">
